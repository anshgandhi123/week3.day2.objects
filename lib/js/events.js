...
function onClick(event) {
    ...
    let difficulty1 = document.getElementById("difficulty");
    let saying1 = document.getElementById("saying");
    name1.innerText = ""
    type1.innerText = ""
    difficulty1.innerText = ""
    saying1.innerText = ""
    input.appendChild(name1);
    input.appendChild(type1);
    input.appendChild(difficulty1);
    input.appendChild(saying1);
